...
import { Trophy, Award, Users, Calendar, Target, Zap, X } from "lucide-react"
...
const achievements = [
  {
    ...
    description: "Recognized for outstanding leadership in Web3 community building and engagement. This prestigious award was given for consistently exceeding community growth targets and implementing innovative engagement strategies.",
    date: "2024",
    category: "Leadership",
  ...
  },
  {
    ...
    description: "Successfully led and coordinated a team of 120+ members across multiple projects. Developed efficient communication systems and mentoring programs that improved team productivity by 40%.",
    date: "2023-2024",
    category: "Management",
  ...
  },
  {
    ...
    description: "Organized and hosted events with 700+ attendees, achieving 95% satisfaction rate. These events ranged from AMA sessions to gaming tournaments and educational workshops.",
    date: "2023",
    category: "Events",
  ...
  },
  {
    ...
    description: "Achieved 400% community growth rate across Discord and social platforms through strategic content, engagement initiatives, and targeted community building efforts.",
    date: "2023",
    category: "Growth",
  ...
  },
  {
    ...
    description: "Developed innovative engagement strategies adopted by leading DeFi protocols. Created frameworks for community onboarding and retention that became industry standards.",
    date: "2024",
    category: "Innovation",
  ...
  },
  {
    ...
    description: "Expert-level proficiency across Discord, Telegram, Twitter, and emerging Web3 platforms. Implemented cross-platform strategies that unified community experiences.",
    date: "Ongoing",
    category: "Technical",
            ...
            <div className="relative aspect-square max-w-xl mx-auto">
              ...
              {achievements.map((achievement, index) => {
                ...
                return (
                  <motion.button
                    key={achievement.id}
                    className={`absolute w-16 h-16 rounded-full bg-gradient-to-r ${achievement.color} p-1 cursor-pointer z-10 shadow-lg hover:shadow-premium transition-shadow`}
                    style={{
                      left: `${pos.x}%`,
                      top: `${pos.y}%`,
          ...
          {selectedAchievement && (
            ...
            >
              <motion.div
                ...
                className="bg-card border border-border rounded-2xl p-8 max-w-lg w-full shadow-premium relative"
              ...
              >
                ...
                <div className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${selectedAchievement.color} flex items-center justify-center mb-6`}>
