    ...
    >
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <span className={isScrolled ? "text-foreground" : "text-white"}>ARB</span>
          </motion.a>
            ...
            {navigation.map((item, index) => (
              <motion.a
                ...
                className={`px-4 py-2 font-bold uppercase text-sm tracking-wider transition-colors ${
                  isScrolled 
                    ? "text-foreground border-2 border-transparent hover:border-foreground" 
            ...
            <div className="py-4 space-y-2">
              {navigation.map((item, index) => (
                <motion.a
                  ...
                  whileHover={{ x: 8, backgroundColor: "hsl(var(--foreground))", color: "hsl(var(--background))" }}
